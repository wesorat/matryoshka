...
Revision ID: cf5f90952dd3
Revises:
Create Date: 2026-06-25 14:12:21.158582
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_project_category_slug"), "project_category", ["slug"], unique=True
    )
    op.create_table(
        "users",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("DRAFT", "PUBLISHED", name="project_status"),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
