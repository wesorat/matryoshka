...
1. Откройте веб-приложение по адресу `http://localhost:5173` локально или `https://team6.st.ifbest.org` развернутое
2. Зарегистрируйтесь или войдите в существующий аккаунт.
3. После авторизации можно:
   - просматривать опубликованные проекты;
   - искать проекты по категориям;
   - просматривать карточки проектов;
   - ставить лайки и оставлять комментарии.
4. Для публикации собственного проекта:
   - перейдите в раздел создания проекта;
   - заполните название, описание, аватарку проекта, категорию, используемые технологии;
   - можно добавить несколько картинок и видео для отображения на странице проекта;
   - сохраните проект.
5. В личном кабинете доступны просмотр и редактирование опубликованных проектов.
